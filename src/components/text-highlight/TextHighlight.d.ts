...
declare const TextHighlight: {
    ({ buttonText, children, imageAlt, imageSrc, message, buttonOnClick, variant, imageAlignment, headline, bottomDescription, topDescription, id, ...headerLongProps }: TextHighlightProps): import("react/jsx-dev-runtime").JSX.Element;

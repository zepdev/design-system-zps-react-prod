...
declare const meta: {
    title: string;
    component: {
        ({ buttonText, children, imageAlt, imageSrc, message, buttonOnClick, variant, imageAlignment, headline, bottomDescription, topDescription, id, ...headerLongProps }: import('./TextHighlight.interface').TextHighlightProps): import("react/jsx-dev-runtime").JSX.Element;
